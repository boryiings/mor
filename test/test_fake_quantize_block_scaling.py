...
class FakeQuantizeBlockScalingTests(unittest.TestCase):
    def SetUp(self):
        torch.manual_seed(0)
    ...
    def test_uint32_matrix_e4m3(self):
        dim_x = 256
        dim_y = 256
        block_x = 128
        block_y = 128
        ...
        bf16_mor_out, meta, global_amax, global_non_zero, global_error = mor.ops.fake_quantize_block_scaling(
            matrix_cuda,
            dim_x,
            dim_y,
            block_x,
    ...
    def test_uint32_matrix_bf16(self):
        dim_x = 256
        dim_y = 256
        block_x = 128
        block_y = 128
    ...
    def test_random_matrix_large_block_small_range(self):
        dim_x = 256
        dim_y = 256
        block_x = 128
        block_y = 128
    ...
    def test_random_matrix_large_block_large_range(self):
        dim_x = 256
        dim_y = 256
        block_x = 128
        block_y = 128
    ...
    def test_random_matrix_large_block_large_range_inplace(self):
        dim_x = 256
        dim_y = 256
        block_x = 128
        block_y = 128
        ...
        meta, global_amax, global_non_zero, global_error = mor.ops.fake_quantize_block_scaling_inplace(
            matrix_cuda,
            dim_x,
            dim_y,
            block_x,
